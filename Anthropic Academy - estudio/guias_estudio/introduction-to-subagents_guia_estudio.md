# Certificate for Introduction to subagents

Fuente: https://anthropic.skilljar.com/introduction-to-subagents

## Para que sirve

This certificate verifies that David Álvarez Iglesias completed Introduction to subagents
